...
public class Curvas {
    ...
    public BufferedImage curva100pts(BufferedImage imagen, int xInicial, int yInicial, int amplitud, int longitud, Color color) {
        ...
        Figuras curva = new Figuras(buffer);
        ...
        while(j < PUNTOS) {
            curva.bresenham(puntosX[j], puntosY[j], puntosX[j+1], puntosY[j+1], color, imagen);
            j++;
        }
    ...
    public BufferedImage parametrica(BufferedImage imagen, int xInicial, int yInicial, int amplitud, int longitud, Color color) {
        ...
        int j=0;
        while(j < PUNTOS) {
            figuras.bresenham(puntosX[j], puntosY[j], puntosX[j+1], puntosY[j+1], color, imagen);
            j++;
        }        
    ...
    public BufferedImage flor(BufferedImage image, int xInicial, int yInicial, int amplitud, int longitud, Color color) {
        ...
        int j=0;
        while(j < PUNTOS) {
            figuras.bresenham(puntosX[j], puntosY[j], puntosX[j+1], puntosY[j+1], color, image);
            j++;
        }
