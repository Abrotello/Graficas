...
public class Ventana extends JPanel {
    ...
    private int[] vectorProyeccion = { 0, 0, 10 };

    private int xcentro = 40;
    private int ycentro = 40;
    ...
    private void proyeccion() {
        ...
        figuras.rellenarRectangulo(figuraX1[0], figuraY1[0], figuraX1[3], figuraY1[3], color2);
        figuras.rellenarRectangulo(figuraX2[0], figuraY2[0], figuraX2[3], figuraY2[3], color2);
